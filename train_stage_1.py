...
def log_validation(
    ...
    ref_image_paths = [
        "/home/ssheikholeslami/Moore-AnimateAnyone/configs/inference/pose_images/9.PNG",
        "/home/ssheikholeslami/Moore-AnimateAnyone/configs/inference/pose_images/8.jpg",
    ]
    pose_image_paths = [
        "/home/ssheikholeslami/Moore-AnimateAnyone/configs/inference/pose_images/SSSS.PNG",
        "/home/ssheikholeslami/Moore-AnimateAnyone/configs/inference/pose_images/SSSS.PNG",
    ]
...
def main(cfg):
    ...
    train_dataset = HumanDanceDataset(
        # img_size=(cfg.data.train_width, cfg.data.train_height),  # there was an error here change it
    ...
    for epoch in range(first_epoch, num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if global_step >= cfg.solver.max_train_steps:
                ...
                break
            # print(str(accelerator.is_main_process)+ " " +str(epoch+1) + str(( epoch + 1 ) % cfg.save_model_epoch_interval == 0 )+ 'oooooooooooooooooooooooooooooooooooooooooooooooo')
        # save model after each epoch I moved this block
            if accelerator.is_main_process and (global_step%cfg.checkpointing_steps==0):
            # if (accelerator.is_main_process):
                print("saveddddddddddddddddddddd")
