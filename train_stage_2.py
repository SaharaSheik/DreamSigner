...
def log_validation(
    ...
    tmp_denoising_unet = tmp_denoising_unet.to(dtype=torch.float32)
    ...
    test_cases = [
        (
            ...
            "/groups/sernam/ASL/raw_videos_dwpose/openpose_output/video/_20g7MG8K1U_18-8-rgb_front.mp4",
        ),
        (
            "/home/ssheikholeslami/Moore-AnimateAnyone/configs/inference/pose_images/8.jpg",
            "/groups/sernam/ASL/raw_videos_dwpose/openpose_output/video/_2u0MkRqpjA_1-5-rgb_front.mp4",
        ),
    ]
    ...
    for epoch in range(first_epoch, num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if global_step >= cfg.solver.max_train_steps:
                break
        # save model after each epoch (I brough this forward)
            # print(str(global_step%cfg.checkpointing_steps), global_step%cfg.checkpointing_steps)
