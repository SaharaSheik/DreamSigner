...
# pose_dir = '/groups/sernam/ASL/openpose_output/video'
# This is for GT using Asad's extraction
# pose_dir = '/groups/sernam/ASL/h2sInfo/processedH2STrainVids'
# this is for asad generated keypoints for train
pose_dir = '/groups/sernam/ASL/generatedInfo/trainVideos'
